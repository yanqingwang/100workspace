...
def get_hire_chg(l_date, l_reason):
    try:
        ...
        if pd.isnull(l_date):
            ...
            # if l_date != '2019-01-01' and l_date != '2019-03-08':
            if l_date != '2019-01-01' and l_date != '2019-03-08' and l_dateDay.year >= 2019:
...
def simple_analyze(df_data,file_out):
    ...
    # df_datagroup = df_datagroup[df_datagroup['Month'] >= '2019-01' and df_datagroup['Month'] <= '2019-06']
