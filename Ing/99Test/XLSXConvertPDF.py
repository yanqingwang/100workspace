...
class PDFConverter:
    def __init__(self, pathname, export='.'):
        ...
        file_path = 'c:/temp/pdf/'
        self._export_folder = os.path.join(file_path, 'pdfconver')
...
if __name__ == "__main__":
    ...
    pathname = 'c:/Users/z659190/Documents/10 Work/10 MyHRSuit/10 Project/131 learning/30_Workpackages/37 Data migration/1st Submission/'
    # 也支持单个文件的转换
    # pathname = 'test.doc'
